...
\NewDocumentCommand{\PPCFichaAtividade}{ m }{
    ...
    \begin{tcolorbox}[
        ...
        \begin{longtable}{>{\bfseries\raggedright}p{0.25\linewidth}p{0.70\linewidth}}
            ...
            \ATListForEach{#1-pré-requisitos}{\prereq}[{ e }{ e }{, }{}]{%
                % \ATAttributeIfExist[\prereq]{código}{\PPCAtividade{#1}{código}~--~}{}%
                \ATAttributeIfExist[\prereq]{nome abreviado}{\PPCAtividade{\prereq}{nome abreviado}}{\prereq}%
            }
            \\
            \hline
...
\NewDocumentCommand{\ppc@ApresenteTabelaPeriodo}{ O{matriz-principal} m m } {%
    ...
    \ATListForEach{#1-periodo-#2}{\codigo}{%
        ...
        \csedef{ppc@ListaDeRequisitos}{}%
        \csdef{ppc@local@Separador}{}%
        \ATListForEach{\codigo-pré-requisitos}{\prereq}{%
            \ATAttributeIfExist[\prereq]{nome abreviado}{%
                \xappto{\ppc@ListaDeRequisitos}{\ppc@local@Separador\PPCAtividade{\prereq}{nome abreviado}}%
            }{%
                \xappto{\ppc@ListaDeRequisitos}{\ppc@local@Separador\prereq}%
            }%
            \csdef{ppc@local@Separador}{; }%
        }%
