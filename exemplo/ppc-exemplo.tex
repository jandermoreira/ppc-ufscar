...
\begin{itemize}
    ...
    \item Por natureza
    \begin{itemize}
        \item Teóricas: \PPCCargaHoraria{teórica}[\,h]
        \item Práticas. \PPCCargaHoraria{prática}[\,h]
        \item Extensionistas: \PPCCargaHoraria{extensionista}[\,h]
        \item Estágio: \PPCCargaHoraria{estágio}[\,h]
    \end{itemize}
