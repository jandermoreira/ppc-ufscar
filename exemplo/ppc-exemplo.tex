...
\PPCDefinaMatrizCurricular{
    ...
    área = {hum-soc}{
        ...
        5 = {hist-alter, hist-alt-ext},
        6 = {ling-fic-ext, ling-fic},
...
%         eco-fic-avanc, med-fic-ext2, robot-fic-avanc, tec-fic-ext,
%         astro-fic, hist-alt-avanc
%     }{\item \textsc{\Disc}: \PPCDisciplina{\Disc}{nome}\par}
% \end{itemize}

% \begin{itemize}
%     \ATForEach{\Area}{nat-bio, hum-soc, art-ling, tec-eng}{\item \textsc{\Area}: \PPCArea{\Area}{nome}\par}
% \end{itemize}
