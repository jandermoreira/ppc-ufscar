...
\begin{Macrodef}{PPCCargaHoraria}{\OArg{nome-matriz}\MArg{nome-do-item}\OArg{texto-adicional}}{}
    ...
    \begin{itemize}
        ...
        \item \texttt{obrigatória}: número de horas total de atividades curriculares obrigatórias;
        \item \texttt{obrigatória $n$}: número de horas de atividades curriculares obrigatórias para o período $n$;
        \item \texttt{opcional}: número de horas total de atividades curriculares opcionais;
        \item \texttt{opcional $n$}: número de horas de atividades curriculares opcionais para o período $n$;
        \item \texttt{eletiva}: número total de atividades curriculares definidas como eletivas.
    \end{itemize}
